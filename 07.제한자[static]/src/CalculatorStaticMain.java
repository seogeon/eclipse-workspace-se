...
public class CalculatorStaticMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(Calculator.add(232, 1232));
		System.out.println(Calculator.sub(232, 1232));
		System.out.println(Calculator.mul(232, 1232));
		System.out.println(Calculator.div(232, 1232));
